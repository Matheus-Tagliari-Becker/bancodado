...
@app.post("/funcionarios", dependencies=[Depends(JWTBearer())], response_model=schemas.Funcionario)
...
@app.put("/funcionarios/{funcionario_id}}", dependencies=[Depends(JWTBearer())], response_model=schemas.Funcionario)
...
@app.delete("/funcionarios/{funcionario_id}", dependencies=[Depends(JWTBearer())])
...
@app.get("/funcionarios", dependencies=[Depends(JWTBearer())], response_model=schemas.PaginatedFuncionario)
...
@app.post("/clientespreferenciais", dependencies=[Depends(JWTBearer())], response_model=schemas.ClientePreferencial)
...
@app.put("/clientespreferenciais/{clientepreferencial_id}}", dependencies=[Depends(JWTBearer())], response_model=schemas.ClientePreferencial)
...
@app.delete("/clientespreferenciais/{clientepreferencial_id}", dependencies=[Depends(JWTBearer())])
...
@app.get("/clientespreferenciais", dependencies=[Depends(JWTBearer())], response_model=schemas.PaginatedClientePreferencial)
def get_all_clientes(db: Session = Depends(get_db), offset: int = 0, limit: int = 10):
...
@app.post("/remedios", dependencies=[Depends(JWTBearer())], response_model=schemas.Remedio)
...
@app.put("/remedios/{remedio_id}}", dependencies=[Depends(JWTBearer())], response_model=schemas.Remedio)
...
@app.delete("/remedios/{remedio_id}", dependencies=[Depends(JWTBearer())])
...
@app.get("/remedios", dependencies=[Depends(JWTBearer())], response_model=schemas.PaginatedRemedio)
